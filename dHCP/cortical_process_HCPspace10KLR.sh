...
base_dir="/scratch_tmp/prj/cortical_imaging/kaili_tmp/dHCP_DL/dHCP_surface_fsLR_clean874"
...
while IFS= read -r line; do
    ...
    wb_command -surface-sphere-project-unproject \
     ...
     "/scratch_tmp/prj/cortical_imaging/kaili_tmp/dHCP_DL/templates/LR_vertexCorre_templates/week40_left_LR.32k.sphere.surf.gii" \
     "/scratch_tmp/prj/cortical_imaging/kaili_tmp/dHCP_DL/templates/template_to_template/LR_templates/dHCPweek40LR_HCP.left.sphere.reg.surf.gii" \
    ...
    wb_command -surface-sphere-project-unproject \
     ...
     "/scratch_tmp/prj/cortical_imaging/kaili_tmp/dHCP_DL/templates/LR_vertexCorre_templates/week40_right_LR.32k.sphere.surf.gii" \
     "/scratch_tmp/prj/cortical_imaging/kaili_tmp/dHCP_DL/templates/template_to_template/LR_templates/dHCPweek40LR_HCP.right.sphere.reg.surf.gii" \
