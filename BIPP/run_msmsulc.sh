...
base_src_dir="/data/BIPP_dhcprecon"
base_dst_dir="/data/BIPP_dhcprecon/MSM_alignment/dataset"

# Config file and template paths
conf_file="${base_src_dir}/config_subject_to_40_week_template_3rd_release"
left_ref_mesh="${base_src_dir}/HCPpipelines/global/templates/standard_mesh_atlases/fsaverage.L_LR.spherical_std.164k_fs_LR.surf.gii"
right_ref_mesh="${base_src_dir}/HCPpipelines/global/templates/standard_mesh_atlases/fsaverage.R_LR.spherical_std.164k_fs_LR.surf.gii"
left_ref_data="${base_src_dir}/HCPpipelines/global/templates/standard_mesh_atlases/L.refsulc.164k_fs_LR.shape.gii"
right_ref_data="${base_src_dir}/HCPpipelines/global/templates/standard_mesh_atlases/R.refsulc.164k_fs_LR.shape.gii"

# Read each subject ID from the file
cat /data/BIPP_dhcprecon/newsample_list23.txt | while read subject_id; do
    echo "Processing ${subject_id}..."

    # Define subject-specific paths
    src_dir="${base_src_dir}/BIPP_T1ciftify6/${subject_id}/MNINonLinear/Native"
